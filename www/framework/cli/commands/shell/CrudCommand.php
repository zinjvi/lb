...
class CrudCommand extends CConsoleCommand
{
	 ...
	 */
	public $actions=array('create','update','index','view','adminka','_form','_view','_search');
 ...
 * Generates CRUD for the Post model which belongs to module 'adminka':
        crud adminka.models.Post

 * Generates CRUD for the Post model. The generated controller should
   belong to module 'adminka', but not the model class:
        crud Post adminka/post

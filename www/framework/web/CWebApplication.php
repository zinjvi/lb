 ...
 * For example, the controller 'articles' is defined by the class 'ArticleController'
...
class CWebApplication extends CApplication
{
	 ...
	 * the corresponding controller. For example, if the route is "adminka/user/create",
	 * then the controller will be created using the class file "protected/controllers/adminka/UserController.php".</li>
	 * </ol>

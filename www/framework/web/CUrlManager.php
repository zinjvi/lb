 ...
 *   '/path/to/index.php/articles/13', it should be treated as '/path/to/index.php/articles/read?id=13';
 ...
 * For example, the URL <code>http://adminka.example.com/en/profile</code> may be parsed into GET parameters
 * <code>user=adminka</code> and <code>lang=en</code>. On the other hand, rules with hostname may also be used to
...
class CUrlManager extends CApplicationComponent
{
	...
	/**
	 * Constructs a URL.
	 * @param string $route the controller and the action (e.g. articles/read)
